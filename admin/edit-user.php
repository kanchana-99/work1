                ...
                <div class="card mb-12">
                  ...
                  <form action="edit-user-api.php" method="post" >
                    <?php $editid = $_GET['id'];
                        ...
                        $query->bindParam(':eid',$editid,PDO::PARAM_STR); //ใส่ตอนมีเงื่อนไข where
                        $query->execute();
                    ...
                    ?>
                        <input type="hidden" name="eid" id="eid" value="<?php echo $editid; ?>">
                                ...
                                <div class="form-group">
                                  ...
                                  <input type="text" maxlength="10" pattern="[0-9]{10}" title="ใส่ตัวเลขสิบหลักเท่านั้น" class="form-control" id="usermobile" placeholder="Enter Mobile" name="usermobile" 
